...
- See `CHANGES_AND_TASK_EDITING_TUTORIAL.md` for a summary of framework changes and a task-editing tutorial.
...
- `CHANGES_AND_TASK_EDITING_TUTORIAL.md`: change summary + brief task authoring tutorial.
